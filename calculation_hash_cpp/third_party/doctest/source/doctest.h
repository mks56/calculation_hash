...
#define DOCTEST_GLOBAL_NO_WARNINGS(var)                             \
  ...
  static int var DOCTEST_UNUSED /* NOLINT */
...
//-V:SCENARIO_TEMPLATE:603
//-V:SCENARIO_TEMPLATE_DEFINE:603

#define DOCTEST_SCENARIO(name) DOCTEST_TEST_CASE("  Scenario: " name)  // NOLINT(readability-function-size)
#define DOCTEST_SCENARIO_CLASS(name) DOCTEST_TEST_CASE_CLASS("  Scenario: " name)  // NOLINT(readability-function-size)
#define DOCTEST_SCENARIO_TEMPLATE(name, T, ...)  DOCTEST_TEST_CASE_TEMPLATE("  Scenario: " name, T, __VA_ARGS__)  // NOLINT(readability-function-size)
#define DOCTEST_SCENARIO_TEMPLATE_DEFINE(name, T, id) DOCTEST_TEST_CASE_TEMPLATE_DEFINE("  Scenario: " name, T, id)  // NOLINT(readability-function-size)
    ...
    if (rb.m_at &
      ...
      s << (rb.m_threw ? "threw as expected!" : "did NOT throw at all!")
        << "\n";
               ...
               assertType::is_throws_as) {  //! OCLINT bitwise
